...
public static class ThemeType
{
	...
	public const string AnimatedImage = "AnimatedImage";
}
...
public class ThemeDefinition
{
	...
	public string? NormalizedType()
	{
		...
		if (string.Equals(Type, ThemeType.AnimatedImage, StringComparison.OrdinalIgnoreCase))
		{
			return ThemeType.AnimatedImage;
		}
